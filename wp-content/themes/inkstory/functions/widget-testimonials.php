...
function testimonials_Widget() {
	...
	$widget_options = array(
		...
		'description' => esc_html__('Custom testimonials widget.','inkstory')
	);
	...
	$this->WP_Widget( 'testimonials_widget', esc_html__('Pego - Testimonials Widget','inkstory'), $widget_options, $control_options );
	...
	/* Set the default values  */
	 ...
	 ?>
		...
		<textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id( 'description' ); ?>" 
				 ...
				 <?php _e('Notice: You may choose from ','inkstory'); ?><?php echo $list_allTest; ?><?php _e('. Divide them with ", "','inkstory'); ?>
		</label>
