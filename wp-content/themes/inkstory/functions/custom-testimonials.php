...
function testimonials_register() {
	...
	$labels = array(
		...
		'singular_name' => esc_html__('Testimonials Item',  "inkstory"),
		'add_new' => esc_html__('Add New',  "inkstory"),
		'add_new_item' => esc_html__('Add New Testimonials Item', "inkstory"),
		'edit_item' => esc_html__('Edit Testimonials Item', "inkstory"),
		'new_item' => esc_html__('New Testimonials Item', "inkstory"),
		'view_item' => esc_html__('View Testimonials Item', "inkstory"),
		'search_items' => esc_html__('Search Testimonials', "inkstory"),
...
function hybrid_create_meta_box_testimonials() {
	global $theme_name;
	add_meta_box( 'post-meta-boxes_testimonials', esc_html__('Testimonials options', "inkstory"), 'post_meta_boxes_testimonials', 'testimonials', 'normal', 'default' );
}
...
function hybrid_post_meta_boxes_testimonials() {
	...
	$meta_boxes = array(				
			'test_name' => array( 
							'name' => 'test_name', 
							'title' => esc_html__(' Author name', 'inkstory'), 
							'description' => esc_html__('Enter testimonial author name.', 'inkstory'), 
							'type' => 'text' ),
			'test_image' => array( 
							'name' => 'test_image', 
							'title' => esc_html__(' Author image', 'inkstory'), 
							'description' => esc_html__('Upload image for author.', 'inkstory'), 
							'type' => "upload")	
	);
 ...
 * parameters.  Used for__(' Type:', 'inkstory'),  both the post/page meta boxes.
 *
 * @since 0.3
 * @param array $args
 * @param array string|bool $value
