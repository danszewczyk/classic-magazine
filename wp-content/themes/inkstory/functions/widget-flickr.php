...
function flickr_Widget() {
	...
	$widget_options = array(
		...
		'description' => esc_html__('Custom Flickr widget.','inkstory'));
	...
	$this->WP_Widget( 'flickr_widget', esc_html__('Pego - Flickr Widget','inkstory'), $widget_options, $control_options );
...
function form( $instance ) {  
		...
		/* Set default values. */
		$defaults = array(
		'title' => esc_html__('Flickr Widget','inkstory'),
