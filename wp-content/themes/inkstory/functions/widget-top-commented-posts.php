...
function top_commented_Widget() {
	...
	$widget_options = array(
		...
		'description' => esc_html__('Custom top commented posts.','inkstory')
	);
	...
	$this->WP_Widget( 'top_commented_widget', esc_html__('Pego - Top Commented Posts Widget','inkstory'), $widget_options, $control_options );
					...
					?>
						...
						<div class="top-commented-post">
							<div class="top-commented-icon-wrap">
								<i class="top-commented-icon icon-comment"><span><?php echo get_comments_number($post->ID); ?></span></i>
							</div>
