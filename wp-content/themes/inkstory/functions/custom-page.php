...
function hybrid_create_meta_box_page() {
	...
	add_meta_box( 'page-meta-boxes', esc_html__('Page settings', "inkstory"), 'page_meta_boxes', 'page', 'normal', 'default' );
}
...
function hybrid_page_meta_boxes() {
	...
	$meta_boxes = array(
			'pego_page_titles_show' => array( 
							...
							'title' => esc_html__('Show page title?', 'inkstory'), 
							'description' => esc_html__('Select Yes to make page title visible for current page.', 'inkstory'), 
							'type' => "select", 
							'options' => array(esc_html__('Yes', "inkstory") => "yes",esc_html__('No', "inkstory") => "no")),
			'pego_page_titles_show_bg' => array( 
							'name' => 'pego_page_titles_show_bg', 
							'title' => esc_html__('Show page title background?', 'inkstory'), 
							'description' => esc_html__('Select Yes to make page title background visible.', 'inkstory'), 
							'type' => "select", 
							'options' => array(esc_html__('No', "inkstory") => "no",esc_html__('Yes', "inkstory") => "yes")),
			'pego_page_titles_bg_image' => array( 
							'name' => 'pego_page_titles_bg_image', 
							'title' => esc_html__('Page title background image', 'inkstory'), 
							'description' => esc_html__('Upload background image for page titles.', 'inkstory'), 
							'type' => "upload"),
			'pego_page_title_page_title_text' => array( 
							'name' => 'pego_page_title_page_title_text',
							'title' => esc_html__('Additional text  for page titles', 'inkstory'), 
							'description' => esc_html__('Enter additional text for page titles [optional].','inkstory'),
							'type' => 'text' ),
			'pego_page_sidebar' => array( 
							'name' => 'pego_page_sidebar', 
							'title' => esc_html__('Select sidebar for the page?', 'inkstory'), 
							'description' => esc_html__('Select a sidebar if you want to have it on the current page.', 'inkstory'), 
							'type' => "select", 
							'options' => $all_sidebars),
			'pego_page_home_template_heading' => array( 
							'name' => 'pego_page_home_template_heading', 
							'title' => esc_html__('Home templates', 'raysmile'), 
							'description' => esc_html__('Settings for home templates.', 'raysmile'), 
							'type' => "heading"),
			'pego_page_home_template_columns' => array( 
							'name' => 'pego_page_home_template_columns', 
							'title' => esc_html__('Columns', 'inkstory'), 
							'description' => esc_html__('Set how may columns you want to display.', 'inkstory'), 
							'type' => "select", 
							'options' => array(esc_html__('1', "inkstory") => "1", esc_html__('2', "inkstory") => "2", esc_html__('3', "inkstory") => "3")),
			'pego_page_titles_show_filter' => array( 
							'name' => 'pego_page_titles_show_filter', 
							'title' => esc_html__('Show post filter?', 'inkstory'), 
							'description' => esc_html__('Select Yes to make post filter visible.', 'inkstory'), 
							'type' => "select", 
							'options' => array(esc_html__('No', "inkstory") => "no",esc_html__('Yes', "inkstory") => "yes")),
			'pego_include_categories' => array( 
							'name' => 'pego_include_categories',
							'title' => esc_html__('Categories', 'inkstory'), 
							'description' => esc_html__('If you want to narrow output, enter category names here. Note: Only listed categories will be included. Divide categories with linebreaks (Enter).','inkstory'),
							'type' => 'textarea' )
