...
function top_rated_Widget() {
	...
	$widget_options = array(
		...
		'description' => esc_html__('Custom top rated posts.','inkstory')
	);
	...
	$this->WP_Widget( 'top_rated_widget', esc_html__('Pego - Top Rated Posts Widget','inkstory'), $widget_options, $control_options );
					...
					?>
						...
						<div class="top-rated-post">
							...
							<div class="top-rated-details">
								...
								<div class="top-rated-date"><?php echo $post_date; ?></div>
							</div>
						</div>
						<div class="clear"></div>
				<?php	
