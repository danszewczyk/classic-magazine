			...
			<div class="page-title-wrapper">
				<div class="page-title">
						<h1><?php echo get_search_query(); ?></h1>
							<div class="page-subtitle"><?php esc_html_e('/ search results','inkstory'); ?></div>
				</div>
			</div>	
			<div class="clear"></div>
		<?php
			...
			<div class="vc_row wpb_row vc_inner vc_row-fluid">
								 				 ...
								 				 $attachments = get_children(array( 'post_parent' => $post->ID,
													...
													$idGallery = rand(1, 10000);						  		
         											foreach($attachments as $att_id => $attachment) {
														$counter++;
														$post_thumbnail = pego_getImageBySize(array(  'attach_id' => $attachment->ID, 'thumb_size' => '770x450' ));
				...
				<?php else : ?>
						<div class="page-wrapper">
							<p class="search-title1"><?php _e( 'Sorry, there is nothing that matches your search.', 'inkstory' ); ?></p>
							<p class="search-title2"><?php _e( 'Please try again with different keywords.', 'inkstory' ); ?></p>
							<div class="clear"></div>
						</div>
				<?php endif; ?>
