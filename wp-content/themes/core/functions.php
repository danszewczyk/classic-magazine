...
define("THEMEUPLOADURL", get_stylesheet_directory_uri()."/data/");
...
?>
	...
	<div id="<?php echo $value['id']; ?>_wrapper" style="width:380px;font-size:11px;">
		<br/><a href="<?php echo get_stylesheet_directory_uri(); ?>/data/<?php echo get_option( $value['id'] ); ?>">
