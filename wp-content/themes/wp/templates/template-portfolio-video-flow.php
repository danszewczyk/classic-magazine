...
foreach($all_photo_arr as $key => $photo)
{
	...
	switch($portfolio_type)
	{
		case 'Youtube Video':
?>
    	<a id="fancy_gallery<?php echo $key; ?>" href="#video_<?php echo $portfolio_video_id; ?>" class="lightbox" <?php if(!empty($pp_display_image_title)) { ?> title="<?php echo $photo->post_title; ?>" <?php } ?>><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/white_slider_handle.png" alt=""/></a>
...
imf.create("imageFlow", '<?php echo get_stylesheet_directory_uri(); ?>/videoFlowXML.php', 0.6, 0.4, 0, 10, 8, 4);
