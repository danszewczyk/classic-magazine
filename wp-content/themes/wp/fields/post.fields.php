...
$postmetas = 
	array (
		...
		'portfolios' => array(
			array("section" => "Content Type", "id" => "portfolio_type", "type" => "select", "title" => "Select content type for this portfolio item:", 
				"items" => array(
					"Youtube Video" => "Youtube Video", 
					"Vimeo Video" => "Vimeo Video", 
				)),
				
				array("section" => "Content Type", "id" => "portfolio_video_id", "title" => "If you select Youtube Video or Vimeo Video. Enter your video ID here:"),
		),
);
