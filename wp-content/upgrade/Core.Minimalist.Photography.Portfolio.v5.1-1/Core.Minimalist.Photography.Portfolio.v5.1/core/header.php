		    ...
		    ?>
			    ...
			    <ul>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="http://twitter.com/<?php echo $pp_twitter_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/twitter.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="http://facebook.com/<?php echo $pp_facebook_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/facebook.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="http://pinterest.com/<?php echo $pp_pinterest_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/pinterest.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="http://instagram.com/<?php echo $pp_instagram_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/instagram.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li class="flickr"><a href="http://flickr.com/people/<?php echo $pp_flickr_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/flickr.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="<?php echo $pp_linkedin_url; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/linkedin.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="http://vimeo.com/<?php echo $pp_vimeo_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/vimeo.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    	<?php
			    		...
			    		{
			    	?>
			    	<li><a href="http://<?php echo $pp_tumblr_username; ?>.tumblr.com" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about_icon/tumblr.png" alt=""/></a></li>
			    	<?php
			    		}
			    	?>
			    </ul>
			    ...
			    $j("#jquery_jplayer_1").jPlayer({
			   	    ready: function () {
			   	        $j(this).jPlayer("setMedia", {
			   	        	mp3: "<?php echo get_stylesheet_directory_uri().'/data/'.$pp_homepage_music_mp3; ?>",
			   	           	m4a: "<?php echo get_stylesheet_directory_uri().'/data/'.$pp_homepage_music_m4a; ?>",
			   	            oga: "<?php echo get_stylesheet_directory_uri().'/data/'.$pp_homepage_music_ogg; ?>",
			   	            end: ""
